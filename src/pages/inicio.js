        ...
        <div>
          <CardDeck>
            ...
            <Card>
              <Card.Img
                variant="top"
                src="https://ambar.com/wp-content/uploads/2019/04/especie.jpg"
              />
              <Card.Body>
                <Card.Title>Recetas con pocos ingredientes </Card.Title>
                <Card.Text>
                  Sabemos que este es uno de los puntos que más te desfavorecen
                  ya que muchas veces queremos hacer una receta pero no cuentas
                  con todos los ingrediente así que aquí encontrarás recetas con
                  pocos ingredientes.
                </Card.Text>
              </Card.Body>
              <Card.Footer>
            ...
            <Card>
              <Card.Img
                variant="top"
                src="https://www.lavanguardia.com/files/image_449_220/uploads/2020/01/03/5e9977e73a7b5.jpeg"
              />
              <Card.Body>
                <Card.Title>Recetas fáciles de preparar</Card.Title>
                <Card.Text>
                  Te enseñaremos algunas recetas en donde podrás sorprender a
                  los tuyos de una forma creativa y mejor aún fácil.{" "}
                </Card.Text>
              </Card.Body>
              <Card.Footer>
                <small className="text-muted">Last updated 3 mins ago</small>
